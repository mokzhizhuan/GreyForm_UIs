...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_wallinterfaces.srv.SetLed')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_wallinterfaces.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from my_robot_wallinterfaces.srv._set_led import SetLed_Request as Request
    from my_robot_wallinterfaces.srv._set_led import SetLed_Response as Response
