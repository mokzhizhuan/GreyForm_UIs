...
size_t my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__size_function__SelectionWall__default_position(
  const void * untyped_member)
{
  const rosidl_runtime_c__int32__Sequence * member =
    (const rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
const void * my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__get_const_function__SelectionWall__default_position(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__int32__Sequence * member =
    (const rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
void * my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__get_function__SelectionWall__default_position(
  void * untyped_member, size_t index)
{
  rosidl_runtime_c__int32__Sequence * member =
    (rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
void my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__fetch_function__SelectionWall__default_position(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int32_t * item =
    ((const int32_t *)
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__get_const_function__SelectionWall__default_position(untyped_member, index));
  int32_t * value =
    (int32_t *)(untyped_value);
  *value = *item;
}

void my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__assign_function__SelectionWall__default_position(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int32_t * item =
    ((int32_t *)
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__get_function__SelectionWall__default_position(untyped_member, index));
  const int32_t * value =
    (const int32_t *)(untyped_value);
  *item = *value;
}

bool my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__resize_function__SelectionWall__default_position(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__int32__Sequence * member =
    (rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__SelectionWall_message_member_array[5] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_wallinterfaces__msg__SelectionWall, default_position),  // bytes offset in struct
    NULL,  // default value
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__size_function__SelectionWall__default_position,  // size() function pointer
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__get_const_function__SelectionWall__default_position,  // get_const(index) function pointer
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__get_function__SelectionWall__default_position,  // get(index) function pointer
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__fetch_function__SelectionWall__default_position,  // fetch(index, &value) function pointer
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__assign_function__SelectionWall__default_position,  // assign(index, value) function pointer
    my_robot_wallinterfaces__msg__SelectionWall__rosidl_typesupport_introspection_c__resize_function__SelectionWall__default_position  // resize(index) function pointer
  }
};
