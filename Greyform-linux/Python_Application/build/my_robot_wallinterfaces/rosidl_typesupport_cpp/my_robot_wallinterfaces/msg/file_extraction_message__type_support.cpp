...
static const _FileExtractionMessage_type_support_symbol_names_t _FileExtractionMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_wallinterfaces, msg, FileExtractionMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_wallinterfaces, msg, FileExtractionMessage)),
  }
};
...
{
  return &::my_robot_wallinterfaces::msg::rosidl_typesupport_cpp::FileExtractionMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_wallinterfaces, msg, FileExtractionMessage)() {
  return get_message_type_support_handle<my_robot_wallinterfaces::msg::FileExtractionMessage>();
}
