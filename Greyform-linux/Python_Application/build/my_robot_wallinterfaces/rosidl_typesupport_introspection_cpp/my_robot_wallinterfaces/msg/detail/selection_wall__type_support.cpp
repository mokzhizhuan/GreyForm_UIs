...
size_t size_function__SelectionWall__picked_position(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SelectionWall__picked_position(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__SelectionWall__picked_position(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__SelectionWall__picked_position(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__SelectionWall__picked_position(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__SelectionWall__picked_position(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__SelectionWall__picked_position(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}

void resize_function__SelectionWall__picked_position(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SelectionWall_message_member_array[4] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_wallinterfaces::msg::SelectionWall, picked_position),  // bytes offset in struct
    nullptr,  // default value
    size_function__SelectionWall__picked_position,  // size() function pointer
    get_const_function__SelectionWall__picked_position,  // get_const(index) function pointer
    get_function__SelectionWall__picked_position,  // get(index) function pointer
