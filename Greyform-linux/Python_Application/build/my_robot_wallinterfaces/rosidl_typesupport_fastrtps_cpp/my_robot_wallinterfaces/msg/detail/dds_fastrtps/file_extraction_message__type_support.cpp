...
#include "my_robot_wallinterfaces/msg/detail/file_extraction_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: stl_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.stl_data[0]);
...
{
  auto typed_message =
    static_cast<const my_robot_wallinterfaces::msg::FileExtractionMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_wallinterfaces::msg::FileExtractionMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FileExtractionMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_robot_wallinterfaces::msg::FileExtractionMessage *>(
...
static size_t _FileExtractionMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FileExtractionMessage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FileExtractionMessage__callbacks = {
...
static rosidl_message_type_support_t _FileExtractionMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FileExtractionMessage__callbacks,
...
{
  return &my_robot_wallinterfaces::msg::typesupport_fastrtps_cpp::_FileExtractionMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_wallinterfaces, msg, FileExtractionMessage)() {
  return &my_robot_wallinterfaces::msg::typesupport_fastrtps_cpp::_FileExtractionMessage__handle;
}
