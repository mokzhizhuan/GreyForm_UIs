...
#include "my_robot_wallinterfaces/srv/detail/set_led__rosidl_typesupport_fastrtps_c.h"
...
using _SetLed_Request__ros_msg_type = my_robot_wallinterfaces__srv__SetLed_Request;
...
size_t get_serialized_size_my_robot_wallinterfaces__srv__SetLed_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetLed_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_wallinterfaces__srv__SetLed_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_wallinterfaces
size_t max_serialized_size_my_robot_wallinterfaces__srv__SetLed_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_wallinterfaces__srv__SetLed_Request;
    is_plain =
      (
...
static size_t _SetLed_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_wallinterfaces__srv__SetLed_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_wallinterfaces, srv, SetLed_Request)() {
...
using _SetLed_Response__ros_msg_type = my_robot_wallinterfaces__srv__SetLed_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_wallinterfaces
size_t get_serialized_size_my_robot_wallinterfaces__srv__SetLed_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLed_Response__ros_msg_type * ros_message = static_cast<const _SetLed_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_wallinterfaces__srv__SetLed_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_wallinterfaces
size_t max_serialized_size_my_robot_wallinterfaces__srv__SetLed_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_wallinterfaces__srv__SetLed_Response;
    is_plain =
      (
...
static size_t _SetLed_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_wallinterfaces__srv__SetLed_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_wallinterfaces, srv, SetLed_Response)() {
...
// already included above
// #include "my_robot_wallinterfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_wallinterfaces/srv/set_led.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_wallinterfaces, srv, SetLed)() {
