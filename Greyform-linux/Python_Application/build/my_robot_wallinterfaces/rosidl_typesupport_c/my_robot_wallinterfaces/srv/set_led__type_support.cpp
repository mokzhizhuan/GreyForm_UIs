...
static const _SetLed_Request_type_support_symbol_names_t _SetLed_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_wallinterfaces, srv, SetLed_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_wallinterfaces, srv, SetLed_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_wallinterfaces, srv, SetLed_Request)() {
  return &::my_robot_wallinterfaces::srv::rosidl_typesupport_c::SetLed_Request_message_type_support_handle;
}
...
static const _SetLed_Response_type_support_symbol_names_t _SetLed_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_wallinterfaces, srv, SetLed_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_wallinterfaces, srv, SetLed_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_wallinterfaces, srv, SetLed_Response)() {
  return &::my_robot_wallinterfaces::srv::rosidl_typesupport_c::SetLed_Response_message_type_support_handle;
}
...
static const _SetLed_type_support_symbol_names_t _SetLed_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_wallinterfaces, srv, SetLed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_wallinterfaces, srv, SetLed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_wallinterfaces, srv, SetLed)() {
  return &::my_robot_wallinterfaces::srv::rosidl_typesupport_c::SetLed_service_type_support_handle;
}
