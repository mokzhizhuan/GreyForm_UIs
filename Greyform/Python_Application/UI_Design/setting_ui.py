...
class Ui_SettingForm(object):
    def setupUi(self, SettingForm):
        ...
        self.labeltitlsetting.setGeometry(QRect(370, 20, 381, 32))
        ...
        self.WifiButton.setStyleSheet(u"font-size:18pt; ")
        ...
        self.serviceIPAddressButton.setStyleSheet(u"font-size:18pt; ")
        ...
        self.ServicesButton.setStyleSheet(u"font-size:18pt; ")
        ...
        self.UserButton.setStyleSheet(u"font-size:18pt; ")
        ...
        self.maintitlelabel = QLabel(SettingForm)
        self.maintitlelabel.setObjectName(u"maintitlelabel")
        self.maintitlelabel.setGeometry(QRect(540, 90, 521, 51))
        font1 = QFont()
