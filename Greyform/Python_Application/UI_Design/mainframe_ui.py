...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SettingButton.setGeometry(QRect(620, 10, 151, 51))
        ...
        self.usermanualButton = QPushButton(self.mainconfiguration)
        self.usermanualButton.setObjectName(u"usermanualButton")
        self.usermanualButton.setGeometry(QRect(20, 10, 151, 51))
        ...
        self.usermanualpage = QWidget()
        self.usermanualpage.setObjectName(u"usermanualpage")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.usermanualButton.setText(QCoreApplication.translate("MainWindow", u"User Manual", None))
    # retranslateUi
