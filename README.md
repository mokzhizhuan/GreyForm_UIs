Install python libraries using system commands cmd(linux):<br>
...
##
launch UI(will setup in the subcommand later):
Terminal 1: <br> <br>
colocon build <br>
source devel/setup.bash <br>
python3 launcher.py(this program will launch the fastapi uvicorn)(important) <br>
Terminal 2: <br> <br>
cd react-ui folder (make sure nodejs react and nvm is installed) <br>
npm run dev
