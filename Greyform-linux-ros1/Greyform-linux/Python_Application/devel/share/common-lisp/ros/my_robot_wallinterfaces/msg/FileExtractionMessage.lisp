...
(cl:defmethod status-val ((m <FileExtractionMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_wallinterfaces-msg:status-val is deprecated.  Use my_robot_wallinterfaces-msg:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FileExtractionMessage>)))
  ...
  "be99b8b69cd2a117a0a8d177509a0dff")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FileExtractionMessage)))
  "Returns md5sum for a message object of type 'FileExtractionMessage"
  "be99b8b69cd2a117a0a8d177509a0dff")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FileExtractionMessage>)))
  ...
  (cl:format cl:nil "string excelfile~%uint8[] stl_data~%string status~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FileExtractionMessage)))
  "Returns full string definition for message of type 'FileExtractionMessage"
  (cl:format cl:nil "string excelfile~%uint8[] stl_data~%string status~%~%"))
