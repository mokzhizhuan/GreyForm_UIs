...
bool my_robot_wallinterfaces__msg__file_extraction_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // stl_data
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->stl_data.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'stl_data'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FileExtractionMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_wallinterfaces.msg._file_extraction_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FileExtractionMessage");
  ...
  {  // stl_data
    ...
    if (ros_message->stl_data.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->stl_data.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->stl_data.size * sizeof(uint8_t));
      assert(data != NULL);
