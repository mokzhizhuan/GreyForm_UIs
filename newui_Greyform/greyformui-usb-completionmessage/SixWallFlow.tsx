...
// - Auto Mode Instructions overlay with multi-step pages
// =========================================================

import React, { useEffect, useMemo, useRef, useState } from "react";
import axios from "axios";

import placementOne from "../assets/six_wall_flow/6_wall_flow_placement1.png";
import placementTwo from "../assets/six_wall_flow/6_wall_flow_placement2.png";
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <img src={manToAuto5} width="600" alt="Manual to Auto Mode Overview" />
      </>
    ),
  },
  {
...
const SixWallFlow: React.FC<any> = ({
  ...
  const isWall4MarkingError =
    (!hasError || hasError) && !running && !homeCheckPending && status?.phase === 1 && currentStep === 3;
